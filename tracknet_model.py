"""
TrackNetV3: Arquitectura exacta del paper
Source: https://github.com/qaz812345/TrackNetV3
Paper: TrackNetV3: Enhancing ShuttleCock Tracking with Augmentations and Trajectory Rectification
"""
import torch
...
class TrackNet(nn.Module):
    """TrackNetV3 - Shuttlecock detection model
    Input: sequence of frames (N, seq_len*3+3, 288, 512) - RGB frames + background
    Output: heatmap (N, seq_len, 288, 512) - probability of shuttlecock location
    """
    def __init__(self, in_dim, out_dim):
